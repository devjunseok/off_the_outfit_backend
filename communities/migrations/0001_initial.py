...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image1', models.ImageField(blank=True, null=True, upload_to='feed_images/')),
                ('image2', models.ImageField(blank=True, null=True, upload_to='feed_images/')),
                ('image3', models.ImageField(blank=True, null=True, upload_to='feed_images/')),
                ('image4', models.ImageField(blank=True, null=True, upload_to='feed_images/')),
                ('image5', models.ImageField(blank=True, null=True, upload_to='feed_images/')),
                ('feed', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='feed_images', to='communities.feed')),
            ],
        ),
        migrations.AddField(
            model_name='feed',
