    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rolse', models.CharField(choices=[('ROLE_NORMAL', 'NORMAL'), ('ROLE_MANAGER', 'MANAGER'), ('ROLE_SUPER', 'SUPER')], default='ROLE_NORMAL', max_length=20, verbose_name='권한')),
                ...
                ('term', models.BooleanField(default=False, verbose_name='이용약관 여부')),
