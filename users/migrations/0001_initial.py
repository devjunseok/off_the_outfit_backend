    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('height', models.IntegerField(null=True, verbose_name='키')),
                ('weight', models.IntegerField(null=True, verbose_name='몸무게')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='social')),
            ],
        ),
    ]
