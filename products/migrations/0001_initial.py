# Generated by Django 4.1.3 on 2022-12-02 13:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_rate', models.DecimalField(decimal_places=2, max_digits=3, verbose_name='할인율')),
                ...
                ('category', models.ManyToManyField(blank=True, through='products.ProductCategoryRelation', to='products.category')),
            ],
            options={
                'db_table': 'Products',
            },
