    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand_name_kr', models.CharField(max_length=500, verbose_name='브랜드명_국문')),
                ('brand_name_en', models.CharField(max_length=500, verbose_name='브랜드명_영문')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('main_category_name', models.CharField(max_length=500, verbose_name='메인 카테고리명')),
                ('main_category_number', models.IntegerField(verbose_name='메인 카테고리 번호')),
                ('sub_category_name', models.CharField(max_length=500, verbose_name='서브 카테고리명')),
                ('sub_category_number', models.IntegerField(verbose_name='서브 카테고리 번호')),
                ('category_link', models.CharField(max_length=500, verbose_name='카테고리 링크')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('like', models.ManyToManyField(blank=True, related_name='like_closets', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('name_tag', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='nametags', to='products.nametag', verbose_name='옷장 태그')),
                ('product', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='closet_products', to='products.product')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'closet',
